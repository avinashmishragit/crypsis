...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { description: @table.description, name: @table.name, parent_id: @table.parent_id }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { description: @table.description, name: @table.name, parent_id: @table.parent_id }
    assert_redirected_to table_path(assigns(:table))
  end
